...
#####################################TEST#######################################
master <- read.csv2(paste(github_dir,'Data/NASA_EMIT_Campaign_062024/Data_Sheets/TEST/Datasheet_Test2_06052024.csv',sep=''),sep=',',header=T)
master$File<-str_pad(master$File, 5, pad = "0")
dataset <- data.frame()

for(i in 1:length(master$File)){
  file <- list.files(paste(github_dir,'/Data/NASA_EMIT_Campaign_062024/TEST2',sep=''), full.names = T, pattern = paste(master$File[i],".asd",sep=''))
  print(file)
...
#####################################SandFlats#######################################
master <- read.csv2(paste(github_dir,'Data/NASA_EMIT_Campaign_062024/Data_Sheets/Biocrust/Datasheet_Biocrust_SF_06102024.csv',sep=''),sep=',',header=T)
master$File<-str_pad(master$File, 5, pad = "0")
dataset <- data.frame()

for(i in 1:length(master$File)){
  file <- list.files(paste(github_dir,'/Data/NASA_EMIT_Campaign_062024/SF_soil',sep=''), full.names = T, pattern = paste(master$File[i],".asd",sep=''))
  print(file)
  md<-get_metadata(file)
  temp_data<-get_spectra(file)
  data<-as.numeric(temp_data)
...
###Isolate rock biocrust signatures
...
###Isolate soil biocrust signatures
...
#####################################IC2#######################################
master <- read.csv2(paste(github_dir,'Data/NASA_EMIT_Campaign_062024/Data_Sheets/Biocrust/Datasheet_Biocrust_IC2_06062024.csv',sep=''),sep=',',header=T)
master$File<-str_pad(master$File, 5, pad = "0")
dataset <- data.frame()

for(i in 1:length(master$File)){
  file <- list.files(paste(github_dir,'/Data/NASA_EMIT_Campaign_062024/IC2_soil',sep=''), full.names = T, pattern = paste(master$File[i],".asd",sep=''))
  print(file)
  md<-get_metadata(file)
  temp_data<-get_spectra(file)
  data<-as.numeric(temp_data)
...
ggplot(soil_mean_std, aes(x=wavelength,y=mean,group=type,color=type)) +
  ...
  theme(axis.text.x = element_text(angle = 45, hjust = 1, vjust = 1)) +
  theme(text = element_text(size = 18))
ggsave(paste(github_dir,'/figures/CR2_Full_Soil_LCY.png',sep=''),dpi=300,width=180,height=120,units='mm')
...
#####################################IC1#######################################
master <- read.csv2(paste(github_dir,'Data/NASA_EMIT_Campaign_062024/Data_Sheets/Biocrust/Datasheet_Biocrust_IC1_06072024.csv',sep=''),sep=',',header=T)
master$File<-str_pad(master$File, 5, pad = "0")
dataset <- data.frame()

for(i in 1:length(master$File)){
  file <- list.files(paste(github_dir,'/Data/NASA_EMIT_Campaign_062024/IC1_soil',sep=''), full.names = T, pattern = paste(master$File[i],".asd",sep=''))
  print(file)
  md<-get_metadata(file)
  temp_data<-get_spectra(file)
  data<-as.numeric(temp_data)
...
ggplot(soil_mean_std, aes(x=wavelength,y=mean,group=type,color=type)) +
  ...
  theme(axis.text.x = element_text(angle = 45, hjust = 1, vjust = 1)) +
  theme(text = element_text(size = 18))
ggsave(paste(github_dir,'/figures/CR1_Full_Soil_LCY.png',sep=''),dpi=300,width=180,height=120,units='mm')
...
#####################################IC3#######################################
master <- read.csv2(paste(github_dir,'Data/NASA_EMIT_Campaign_062024/Data_Sheets/Biocrust/Datasheet_Biocrust_IC3_06082024.csv',sep=''),sep=',',header=T)
master$File<-str_pad(master$File, 5, pad = "0")
dataset <- data.frame()

for(i in 1:length(master$File)){
  file <- list.files(paste(github_dir,'/Data/NASA_EMIT_Campaign_062024/IC3_soil',sep=''), full.names = T, pattern = paste(master$File[i],".asd",sep=''))
  print(file)
  md<-get_metadata(file)
  temp_data<-get_spectra(file)
  data<-as.numeric(temp_data)
...
ggplot(soil_mean_std, aes(x=wavelength,y=mean,group=type,color=type)) +
  ...
  theme(axis.text.x = element_text(angle = 45, hjust = 1, vjust = 1)) +
  theme(text = element_text(size = 18))
ggsave(paste(github_dir,'/figures/CR3_Full_Soil_LCY.png',sep=''),dpi=300,width=180,height=120,units='mm')
