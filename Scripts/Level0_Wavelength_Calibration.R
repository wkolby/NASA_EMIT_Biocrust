...
#####################################TEST#######################################
dataset <- c()
file_list <- list.files(paste(github_dir,'/Data/Wavelength_Calibration_2025/UA_ASD_FieldSpec3/',sep=''), full.names = T, pattern = ".asd")
...
file_list <- list.files(paste(github_dir,'/Data/Wavelength_Calibration_2025/JPL_ASD_FieldSpec4/',sep=''), full.names = T, pattern = ".asd")
for(i in 1:length(file_list)){
  print(file_list[i])
  md<-get_metadata(file_list[1])
  temp_data<-get_spectra(file_list[1])
...
file_list <- list.files(paste(github_dir,'/Data/Wavelength_Calibration_2025/USGS_ASD_FieldSpec4/',sep=''), full.names = T, pattern = ".asd")
for(i in 1:length(file_list)){
  print(file_list[i])
  md<-get_metadata(file_list[1])
  temp_data<-get_spectra(file_list[1])
...
ggsave(paste(github_dir,'/figures/Wavelength_Calibration_ALL_ASDs.png',sep=''),dpi=300,width=180,height=120,units='mm')
